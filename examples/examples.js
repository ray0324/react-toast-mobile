...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_toast__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_toast___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react_toast__);
...
window.T = __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"];
...
var App = function App() {
    ...
    var click1 = function click1() {
        __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].confirm({
            title: '标题',
            message: '消息',
            option: [{
                text: '点赞',
    ...
    var click2 = function click2() {
        __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].confirm({
            ...
            option: [{
                text: '确定',
                fn: function fn() {
                    return __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].notify('已确定。');
                }
            }, {
                text: '取消'
            }]
    ...
    var click3 = function click3() {
        __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].loading('加载中');
        setTimeout(__WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].loaded, 2000);
    };
    var click4 = function click4() {
        __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].progress.start('视频上传中');
        var i = 0.1;
        var interval = setInterval(function () {
            ...
            if (i >= 1) {
                ...
                i = 1;
                __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].progress.done('上传完成!');
                return;
            };
            __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].progress.set(i);
        }, 200);
    };
    var click5 = function click5() {
        return __WEBPACK_IMPORTED_MODULE_2_react_toast__["T"].notify('密码错误');
    };

    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_toast___default.a, null),
